...
def compute_overall_consistency(json_dir, device, submodules_list, **kwargs):
    # Use default_bpe() which now has local file fallback
    from vbench.third_party.ViCLIP.simple_tokenizer import default_bpe
    
    tokenizer = SimpleTokenizer(default_bpe())
